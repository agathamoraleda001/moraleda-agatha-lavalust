...
<main class="container">
    ...
    <div class="form-card">
        <form method="POST" action="<?= site_url('products/create') ?>">
            ...
            <div class="form-group">
                <label>Price</label>
                <input type="number" name="price" placeholder="Enter product price" step="0.01" min="0" required>
            </div>

            <div class="form-group">
                <label>Quantity</label>
                <input type="number" name="quantity" placeholder="Enter product quantity" min="0" required>
            </div>
